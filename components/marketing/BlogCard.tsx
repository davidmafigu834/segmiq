...
export default function BlogCard({ post }: { post: Post }) {
  return (
    <Link href={`/blog/${post.slug}`} className="group flex flex-col rounded-2xl overflow-hidden border border-black/[0.08] transition-transform duration-300 hover:-translate-y-1">
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <p className="mt-1.5 text-sm text-[#5b5b5b]">{post.excerpt}</p>
        <div className="mt-4 pt-3 border-t border-black/[0.08] flex items-center gap-2 text-xs text-[#8a8a8a]">
