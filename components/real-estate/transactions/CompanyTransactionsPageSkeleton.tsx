...
export function CompanyTransactionsPageSkeleton() {
  return (
    <CompanyPageSkeletonShell label="Loading transactions">
      <div className="space-y-4 sm:space-y-5">
        <PageHeaderSkeleton titleWidth="w-36" subtitleWidth="w-96" />
        <KpiRowSkeleton
          count={COMPANY_KPI_COUNTS.transactions}
          gridClass={COMPANY_KPI_GRID.transactions}
        />
        <TableCardSkeleton />
      </div>
    </CompanyPageSkeletonShell>
