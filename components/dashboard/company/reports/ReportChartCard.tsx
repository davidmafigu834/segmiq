    ...
    >
      <header className="flex shrink-0 items-start justify-between gap-3 px-4 pb-1 pt-4 sm:px-[18px] sm:pt-[16px]">
        <div className="min-w-0">
          <h2
            className="truncate text-[14px] font-semibold leading-snug text-sales-text-primary"
            title={hint ?? title}
          >
            {title}
          </h2>
      ...
      <div className={cn("min-h-0 min-w-0 flex-1 px-4 pb-4 pt-2 sm:px-[18px] sm:pb-[16px]", bodyClassName)}>
        {error ? (
