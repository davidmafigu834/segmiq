  ...
  return (
    <div className="p-4">
      ...
      <div className="divide-y divide-sales-border-subtle">
        ...
        {event.location ? <div className="flex gap-3 py-3.5"><MapPin size={15} className="mt-0.5 shrink-0 text-sales-text-muted" /><div><p className="text-[11px] font-medium text-sales-text-muted">Location</p><p className="mt-1 text-[12px] text-sales-text-primary">{event.location}</p></div></div> : null}
        {event.description ? <div className="py-3.5"><p className="text-[11px] font-medium text-sales-text-muted">Description</p><p className="mt-1.5 text-[12px] leading-relaxed text-sales-text-secondary">{event.description}</p></div> : null}
      </div>
...
export function CompanyCalendarAgendaRail({
  ...
  return (
    <aside className="h-full min-h-[760px] overflow-hidden workspace-card rounded-[14px] border border-sales-border-subtle bg-sales-surface shadow-none" data-course-target="calendar-right-agenda">
      {selectedEvent ? (
