  ...
  return (
    <div className="space-y-2 layout:space-y-1.5">
      <div className="hidden min-h-10 items-center justify-between gap-3 layout:flex">
        <p className="min-w-0 truncate text-[11px] font-medium tracking-[0.06em] text-sales-text-muted">
          {dateLabel}
        </p>
        <div className="ml-auto flex shrink-0 flex-nowrap items-center justify-end gap-2">
          ...
          <div className="flex shrink-0 items-center gap-1.5">
            ...
            <div className="relative">
              <button
                type="button"
                className="inline-flex h-10 min-w-[44px] items-center gap-1.5 rounded-[10px] bg-sales-brand px-3.5 text-[13px] font-semibold text-sales-text-primary transition-colors duration-150 hover:bg-sales-brand-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--sales-neutral-900)]/30"
              ...
              {quickOpen ? (
                <>
                  ...
                  <div
                    role="menu"
                    className="absolute right-0 z-30 mt-2 w-56 overflow-hidden rounded-[12px] border border-sales-border bg-sales-surface py-1 shadow-[0_8px_24px_rgba(16,24,40,0.08)]"
                  >
                    <button
                      type="button"
                      role="menuitem"
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1 text-[13px] text-sales-text-secondary sm:mt-1.5 sm:text-[14px]">
