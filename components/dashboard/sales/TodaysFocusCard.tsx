...
export function TodaysFocusCard({
  ...
  return (
    ...
    >
      <CardContent className="flex flex-col gap-5 p-5 sm:flex-row sm:items-center sm:justify-between sm:gap-8 sm:px-6 sm:py-5">
        <div className="min-w-0 flex-1">
          ...
          <p className="dashboard-focus-title mt-3">{focus.title}</p>
          <p className="mt-2.5 max-w-2xl text-[13px] leading-relaxed text-sales-text-secondary">
            {focus.body}
          </p>
          ...
          <div className="mt-3.5 flex flex-wrap items-center gap-x-4 gap-y-1 text-[12px] text-sales-text-muted">
        ...
        <Link
          href={cta.href}
          className="dashboard-action-btn dashboard-action-btn--next inline-flex min-h-11 shrink-0 items-center justify-center gap-1 rounded-sales-md px-4 text-[13px] font-semibold text-sales-text-primary transition-colors hover:bg-sales-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sales-brand"
        >
          {cta.label}
