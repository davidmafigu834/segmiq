...
const proseBlog =
  "[&_p]:text-[18px] [&_p]:leading-[1.8] [&_p]:text-[#1a1a1a] dark:[&_p]:text-white/85 [&_p]:mt-6 [&_p:first-child]:mt-0 [&_h2]:text-[26px] [&_h2]:font-bold [&_h2]:tracking-tight [&_h2]:mt-12 [&_h2]:mb-3 [&_h3]:text-[20px] [&_h3]:font-semibold [&_h3]:mt-8 [&_h3]:mb-2 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mt-4 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:mt-4 [&_li]:mt-2 [&_li]:text-[18px] [&_li]:text-[#1a1a1a] dark:[&_li]:text-white/85 [&_li]:leading-[1.75] [&_a]:underline [&_a]:underline-offset-2 [&_a]:text-[#76B900] dark:[&_a]:text-[#D4FF4F] [&_a]:font-medium [&_strong]:font-bold [&_em]:italic [&_code]:text-[15px] [&_code]:bg-black/[0.04] dark:[&_code]:bg-white/10 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_pre]:bg-[#0C0C0C] [&_pre]:text-white/90 [&_pre]:p-5 [&_pre]:overflow-x-auto [&_pre]:my-6 [&_blockquote]:border-l-[3px] [&_blockquote]:border-[#76B900] dark:[&_blockquote]:border-[#D4FF4F] [&_blockquote]:pl-5 [&_blockquote]:italic [&_blockquote]:text-[#444] dark:[&_blockquote]:text-white/65 [&_blockquote]:my-8 [&_blockquote]:text-[19px] [&_hr]:my-10 [&_hr]:border-black/[0.08] dark:[&_hr]:border-white/10";
