          ...
          return (
            ...
            >
              ...
              >
                ...
                {showBadge ? (
                  <span
                    className="absolute -right-0.5 -top-0.5 flex h-4 min-w-[16px] items-center justify-center rounded-sales-sm bg-sales-brand px-1 text-[9px] font-semibold text-sales-brand-text"
                    aria-hidden="true"
                  >
                    {badge! > 99 ? "99+" : badge}
                  </span>
