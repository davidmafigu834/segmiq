...
export function ToolCard({
  ...
  const className = cn(
    "group flex h-full flex-col rounded-sales-md border border-sales-border-subtle bg-sales-surface p-5 text-left shadow-none transition-[border-color,background-color] duration-150",
    "hover:border-sales-border-strong hover:bg-sales-surface-hover",
  ...
  const body = (
    <>
      <div className="flex items-start justify-between gap-3">
        <span className="flex h-11 w-11 items-center justify-center rounded-sales-md bg-sales-neutral-100 text-sales-text-secondary">
