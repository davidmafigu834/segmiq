...
import { TransactionsWorkspace } from "@/components/real-estate/transactions/TransactionsWorkspace";
...
export default async function SalesTransactionsPage() {
  ...
  return (
    ...
    >
      ...
      >
        <TransactionsWorkspace clientId={session.clientId} variant="agent" />
      </SalesAppShell>
    </SalesLayout>
  );
}
