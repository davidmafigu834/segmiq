  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 layout:grid-cols-12">
          <Skeleton className="h-[260px] rounded-[10px] layout:col-span-5" />
          <Skeleton className="h-[260px] rounded-[10px] layout:col-span-4" />
          <Skeleton className="h-[260px] rounded-[10px] layout:col-span-3" />
        </div>
      </div>
    </div>
  );
