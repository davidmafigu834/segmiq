...
import { LearningCenterPage } from "@/components/dashboard/company/agent/learning/LearningCenterPage";

export const dynamic = "force-dynamic";

export default async function ClientAgentLearningPage({
  searchParams,
}: {
  searchParams: { clientId?: string; candidate?: string; knowledge?: string };
}) {
  ...
  return (
    ...
    >
      <LearningCenterPage
        clientId={clientId}
        initialCandidateId={searchParams.candidate ?? null}
        initialKnowledgeId={searchParams.knowledge ?? null}
