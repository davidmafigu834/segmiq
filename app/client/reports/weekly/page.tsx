...
import { WeeklyReportsHistoryClient } from "@/components/dashboard/company/weekly-report/WeeklyReportsHistoryClient";
...
export default async function WeeklyReportsPage() {
  ...
  if (!session.clientId && session.role !== "SUPER_ADMIN") redirect("/login");
  ...
  return (
    <ClientManagerLayout
      breadcrumbPage="WEEKLY REPORTS"
      pageTitle="Weekly team performance"
      hideShellHeader
      hideShellSidebar
      navClientId={clientId ?? undefined}
    >
      <WeeklyReportsHistoryClient
