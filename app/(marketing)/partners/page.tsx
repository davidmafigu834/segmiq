    ...
    <>
      <section className="pt-16 pb-12">
        <div className="mx-auto max-w-[1100px] px-5 max-w-[760px]">
          ...
          <p className="mt-5 text-base text-[#5b5b5b] max-w-[560px]">If you work with construction, solar, roofing, electrical, or landscaping businesses across Africa, partner with Segmiq to bring them a system that captures and closes their leads — and earn on every client you bring.</p>
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <a href="#how" className="px-6 py-3 rounded-full border border-black/[0.08] font-semibold hover:border-black/30">How it works</a>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-8">
            {TYPES.map(({ Icon, t, d }) => (
              <div key={t} className="rounded-2xl border border-black/[0.08] p-6 transition-transform duration-300 hover:-translate-y-1">
                ...
                <p className="text-sm text-[#5b5b5b] mt-1.5">{d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="how" className="py-14 bg-[#0C0C0C] text-white">
        <div className="mx-auto max-w-[1100px] px-5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-9">
            {STEPS.map(([t, d], i) => (
              <div key={t} className="rounded-2xl p-6 border border-white/10 bg-[#181818]">
      ...
      <section className="py-14">
        <div className="mx-auto max-w-[1100px] px-5 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-3 text-[15px] text-[#5b5b5b]">Segmiq is built for how trade businesses in Africa actually sell — WhatsApp-first, lead generation included, and two products that cover the whole journey from first enquiry to documented, shareable work.</p>
          ...
          <div className="rounded-2xl bg-[#F8F7F4] border border-black/[0.08] p-7">
            <div className="text-[13px] font-semibold text-[#8a8a8a]">THE CLIENT PROMISE YOU CARRY</div>
            ...
            <p className="mt-3 text-sm text-[#5b5b5b]">Many clients start with no pipeline at all. Segmiq runs the lead generation and gives them the system that converts it — which makes it an easy thing to sell.</p>
          </div>
        </div>
      </section>
      ...
      <section id="apply" className="py-16">
        <div className="mx-auto max-w-[760px] px-5 text-center mb-8">
          ...
          <p className="mt-3 text-[15px] text-[#5b5b5b]">Tell us about your business and the clients you serve. We&apos;ll set you up with a partner plan that fits.</p>
        </div>
