    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e4e4e7;">
        ...
        <tr><td style="padding:40px;">
          <p style="margin:0 0 8px;font-size:13px;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:#71717a;">Payment confirmed</p>
          <h1 style="margin:0 0 24px;font-size:24px;font-weight:700;color:#09090b;">Thank you — payment received</h1>
          <p style="margin:0 0 24px;font-size:15px;color:#3f3f46;line-height:1.6;">
            Hi <strong>${escapeHtml(clientName)}</strong>, we have confirmed your payment of
            <strong>${escapeHtml(amountFormatted)}</strong> for invoice <strong>${escapeHtml(invoiceNumber)}</strong>.
            Your account is active again.
          </p>
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f5;border-radius:12px;padding:18px;margin-bottom:24px;">
            <tr><td>
              <p style="margin:0 0 4px;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:#71717a;">Next renewal</p>
              <p style="margin:0;font-size:15px;color:#09090b;font-weight:500;">${escapeHtml(nextRenewalDate)}</p>
            </td></tr>
          </table>
${ctaBlock}
        </td></tr>
