export function paymentRejectedEmail({
  ...
  const subject = `Action needed on your payment for invoice ${invoiceNumber}`;
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #e4e4e7;">
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <h1 style="margin:0 0 24px;font-size:24px;font-weight:700;color:#09090b;line-height:1.2;">
                We couldn't confirm your payment
              </h1>
              <p style="margin:0 0 20px;font-size:15px;color:#3f3f46;line-height:1.6;">
                Hi <strong>${escapeHtml(clientName)}</strong>, the payment you submitted for invoice
                <strong>${escapeHtml(invoiceNumber)}</strong> (${escapeHtml(amountFormatted)}) could not be confirmed.
              </p>

              <table width="100%" cellpadding="0" cellspacing="0" style="background:#fef2f2;border:1px solid #fecaca;border-radius:12px;padding:18px;margin-bottom:24px;">
                <tr>
                  <td>
                    <p style="margin:0 0 4px;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:#b91c1c;">Reason</p>
                    <p style="margin:0;font-size:14px;color:#7f1d1d;line-height:1.5;">${escapeHtml(reason)}</p>
                  </td>
                </tr>
              </table>

              <p style="margin:0 0 24px;font-size:14px;color:#71717a;line-height:1.6;">
                Please review the details and resubmit your payment, or reply to this email if you believe this is a mistake.
              </p>
${ctaBlock}
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:24px 40px;border-top:1px solid #f4f4f5;">
              <p style="margin:0;font-size:12px;color:#a1a1aa;line-height:1.6;">
                This message was sent by Segmiq regarding your billing.
              </p>
            </td>
          </tr>
