export function inviteSalespersonEmail({
  inviteeName,
  invitedByName,
  clientName,
  role,
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#3f3f46;line-height:1.6;">
                <strong>${escapeHtml(invitedByName)}</strong> has added you to
                <strong>${escapeHtml(clientName)}</strong> as a <strong>${escapeHtml(roleLabel)}</strong>.
                Use the details below to log in and get started.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f5;border-radius:12px;padding:24px;margin-bottom:28px;">
                <tr>
                  <td>
                    <p style="margin:0 0 4px;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:#71717a;">
                      Email
                    </p>
                    <p style="margin:0 0 20px;font-size:15px;color:#09090b;font-weight:500;">
                      ${escapeHtml(email)}
                    </p>
                    <p style="margin:0 0 4px;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.08em;color:#71717a;">
                      Temporary password
                    </p>
                    <p style="margin:0;font-size:18px;color:#09090b;font-weight:700;font-family:monospace;letter-spacing:0.1em;">
