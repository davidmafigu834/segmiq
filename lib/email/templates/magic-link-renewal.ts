export function magicLinkRenewalEmail({
  salespersonName,
  leadName,
  magicLink,
  expiresAt,
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <h1 style="margin:0 0 24px;font-size:26px;font-weight:700;color:#09090b;line-height:1.2;">
                Your link for<br />${leadName} is ready
              </h1>

              <p style="margin:0 0 24px;font-size:15px;color:#3f3f46;line-height:1.6;">
                Hi ${salespersonName}, your previous link expired.
                A fresh link has been generated. Tap the button below
                to log your call or update the lead status.
              </p>
              ...
              <p style="margin:0;font-size:13px;color:#a1a1aa;line-height:1.6;">
                ...
                <span style="color:#3f3f46;word-break:break-all;">${magicLink}</span>
              </p>
