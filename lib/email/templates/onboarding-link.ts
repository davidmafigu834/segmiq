export function onboardingLinkEmail({
  ...
  const subject = clientName
    ? `Set up your Segmiq account — ${clientName}`
    : "Set up your Segmiq account";
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#3f3f46;line-height:1.6;">
                Your agency has invited you to set up Segmiq CRM. Use the link below to add your company details,
                create your account, and finish onboarding. The link expires in ${expiresInDays} days.
              </p>
